                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('/master/poli/' . $dataPoli['id']) . '/edit' ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= (isset($validation)) ? ($validation->hasError('nama')) ? 'is-invalid' : null : null ?>" name="nama" placeholder="ex: Poli Anak" value="<?= $dataPoli['nama']; ?>">
                            <div class="invalid-feedback">
