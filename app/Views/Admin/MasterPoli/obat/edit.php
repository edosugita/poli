                ...
                <div class="card-body">
                    ...
                    <form action="<?= base_url('/master/obat/' . $dataObat['id']) . '/edit' ?>" method="post">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control <?= (isset($validation)) ? ($validation->hasError('satuan')) ? 'is-invalid' : null : null ?>" name="satuan" id="satuan" placeholder="ex: PCS" value="<?= $dataObat['satuan'] ?>">
                            <div class="invalid-feedback">
